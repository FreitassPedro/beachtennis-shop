        ...
        <nav className='sticky top-0 left-0 p-5 bg-black w-full z-1000 justify-center lg:justify-between flex  text-white'>            <a href="" className='lg:block  items-center justify-center lg:justify-between flex-wrap'>
            ...
            <div className='gap-6 items-end hidden lg:flex'>
                ...
                <div className="relative group">
                    ...
                    <div className="absolute bg-black text-white text-nowrap space-y-1 p-5 rounded-lg  right-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none group-hover:pointer-events-auto">
                        <Link to={"/account"} className="hover:text-gray-400 bg-amber-300">
                            <h2>Minha Conta</h2>
                        </Link>
                        <Link to={"/pedidos"}>
                            <h2>Pedidos</h2>
